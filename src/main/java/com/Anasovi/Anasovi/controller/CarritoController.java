...
import com.Anasovi.Anasovi.domain.Item;
import com.Anasovi.Anasovi.service.ItemService;
...
public class CarritoController {
    ...
    private String paginaCarrito(Model model) {
        var productos = productoService.getProductos(false);
        model.addAttribute("productos", productos);

        return "producto/paginaProducto";
    }

    //Para ver el carrito
    @GetMapping("/carrito/paginaCarrito")
    ...
    public String eliminarItem(Item item) {
        ...
        return "redirect:/carrito/paginaCarrito";
    }
